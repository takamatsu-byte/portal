...
export default function RealEstateDashboard() {
  ...
  function upsertProperty(e: React.FormEvent) {
    ...
    const nextItem: Property = {
      ...
      expectedSalePriceYen: form.expectedSalePriceYen.trim()
        ? normalizeYenString(form.expectedSalePriceYen.trim())
        : "-",
          ...
          <header className="w-full px-8 flex items-center justify-end h-full">
            <div className="inline-flex items-center rounded-full border border-slate-200 bg-white shadow-sm overflow-hidden my-auto">
              <button
                ...
                aria-label="追加"
              >
                <span className="text-lg font-extrabold leading-none text-[#FD9D24] group-hover:text-white transition">
                  +
                </span>
              ...
              <div className="absolute top-0 right-0 h-full w-[640px] max-w-[95vw] bg-white border-l border-slate-200 shadow-2xl">
                <div className="h-full flex flex-col">
                  <div className="h-20 flex items-center justify-between px-6 border-b border-slate-100 flex-shrink-0">
                    ...
                    <button onClick={() => setIsPanelOpen(false)} className="p-2 rounded-lg hover:bg-slate-100 text-slate-500" aria-label="閉じる">
                      ✕
                    </button>
                  </div>
                      ...
                      <div className="rounded-xl border border-slate-200 p-4">
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <button
                            ...
                            className="group inline-flex items-center gap-2 rounded-full px-3 py-1.5 border border-slate-200 bg-white font-semibold text-sm transition hover:bg-[#FD9D24]"
                            aria-label="内訳を追加"
                            title="内訳を追加"
                          >
                            <span className="inline-flex items-center justify-center w-6 h-6 rounded-full border border-[#FD9D24] text-[#FD9D24] transition group-hover:bg-white group-hover:text-[#FD9D24]">
                              +
                            </span>
                            <span className="text-slate-700 group-hover:text-white transition">追加</span>
                          </button>
                        </div>
